...
interface PropertyListingCardProps {
  ...
  bhk?: number; // Optional for rent properties
}
    ...
    >
      <div className="relative w-full aspect-[4/3] overflow-hidden">
        <div className="absolute top-3 left-3 z-10">
          <span className="bg-primary text-[#141811] text-[11px] font-black uppercase tracking-wider px-2 py-1 rounded">
            {status}
          </span>
        </div>
        <div
      ...
      <div className="p-5 pt-2">
        <div className="flex justify-between items-start mb-2">
          <h3 className="text-[#141811] dark:text-white text-xl font-bold leading-tight font-display">{title}</h3>
        ...
        <div className="flex items-center justify-between py-3 border-y border-[#f2f4f0] dark:border-[#2a3620] mb-4">
          <div className="flex flex-col">
            ...
            <span className="text-[#141811] dark:text-white font-bold">{areaSize}</span>
          </div>
